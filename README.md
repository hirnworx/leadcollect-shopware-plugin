...
[![Version](https://img.shields.io/badge/Version-1.5.0-orange)](https://github.com/hirnworx/leadcollect-shopware-plugin/releases)
...
### v1.5.0 (2026-04-10)
- **KRITISCHER FIX:** Shopware 6.6+ Kundendaten werden jetzt korrekt abgerufen
- In Shopware 6.6+ sind Kundendaten nicht mehr im Cart-Payload enthalten
- Plugin nutzt jetzt JOIN auf sales_channel_api_context, customer und customer_address Tabellen
- Besseres Logging fuer Debugging
- Health-Endpoint zeigt jetzt Plugin-Version und Fix-Info
